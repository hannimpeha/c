...
turtles-own [location energy trust]
...
to go
  ask turtles [
    let closest-trader min-one-of (other turtles) [distance myself]
    face closest-trader
    ifelse distance closest-trader <= 0 [transact][fd 1]
...
true
0
Line -7500403 true 240 30 60 30
Line -7500403 true 60 270 240 270
Line -7500403 true 60 30 0 150
Line -7500403 true 0 150 60 270
Line -7500403 true 240 30 300 150
Line -7500403 true 300 150 240 270
@#$#@#$#@
0
@#$#@#$#@
