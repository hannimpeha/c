...
to make-turtles
  ...
  create-turtles num-cooperate [ set strategy "cooperate" set color pink ]
  create-turtles num-defect [ set strategy "defect" set color violet + 1 ]
  create-turtles num-tit-for-tat [ set strategy "tit-for-tat" set color sky ]
  create-turtles num-unforgiving [ set strategy "unforgiving" set color yellow - 1 ]
...
to rnetlogo
  if (ticks = 0)[set tvmratio one-of range (count turtles)]
...
to do-trust
  ...
  set unforgiving-trust  (calc-trust "unforgiving")
  set unknown-trust  (calc-trust "unknown")
end
...
to-report calc-grade [grade]
  ifelse ticks > 0 [
    set list-of-trust sort-by > map calc-trust ["random" "cooperate" "defect" "tit-for-tat" "unforgiving" "unknown"]
    ifelse (position (calc-trust "random") list-of-trust = grade) [report "random"][
    ifelse (position (calc-trust "cooperate") list-of-trust = grade) [report "cooperate"][
    ifelse (position (calc-trust "defect") list-of-trust = grade) [report "defect"][
    ifelse (position (calc-trust "tit-for-tat") list-of-trust = grade) [report "tit-for-tat"][
    ifelse (position (calc-trust "unforgiving") list-of-trust = grade) [report "unforgiving"]
    [report "unknown"]
]]]]] [
    report 0
  ]
...
"" ""
PENS
"random" 1.0 0 -955883 true "" "if num-random-games > 0 [ plot random-score / (num-random-games) ]"
"cooperate" 1.0 0 -2064490 true "" "if num-cooperate-games > 0 [ plot cooperate-score / (num-cooperate-games) ]"
"defect" 1.0 0 -6917194 true "" "if num-defect-games > 0 [ plot defect-score / (num-defect-games) ]"
"tit-for-tat" 1.0 0 -13791810 true "" "if num-tit-for-tat-games > 0 [ plot tit-for-tat-score / (num-tit-for-tat-games) ]"
"unforgiving" 1.0 0 -4079321 true "" "if num-unforgiving-games > 0 [ plot unforgiving-score / (num-unforgiving-games) ]"
"unknown" 1.0 0 -10899396 true "" "if num-unknown-games > 0 [ plot unknown-score / (num-unknown-games) ]"
...
"" ""
PENS
"random" 1.0 0 -955883 true "" "if ticks > 0 [plot random-trust / ticks]"
"cooperate" 1.0 0 -2064490 true "" "if ticks > 0 [plot cooperate-trust / ticks]"
"defect" 1.0 0 -6917194 true "" "if ticks > 0 [plot defect-trust / ticks]"
"tit-for-tat" 1.0 0 -13791810 true "" "if ticks > 0 [plot tit-for-tat-trust / ticks]"
"unforgiving" 1.0 0 -4079321 true "" "if ticks > 0 [plot unforgiving-trust / ticks]"
"unknown" 1.0 0 -10899396 true "" "if ticks > 0 [plot unknown-trust / ticks]"
